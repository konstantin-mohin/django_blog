...
tinyMCE.init({
    ...
    theme_advanced_buttons2: 'search,|,pasteword,template,media,charmap,|,code,|,cleanup,|,justifyleft,justifycenter,justifyright,justifyfull,|,fontselect,fontsizeselect',
    ...
    theme_advanced_styles: 'Image Left=img_left;Image Right=img_right;Image Block=img_block;Light Box=box;Table=tbl;Row1=i0;Row2=i1;',
    
    // Style formats
    // see http://wiki.moxiecode.com/index.php/TinyMCE:Configuration/style_formats
    style_formats : [
        {title : 'Содержание', block : 'div', classes: 'contents'},
        {title : 'Заголовок содержания',inline: 'span'},
      //  {title : 'Раскрывающийся блок', wrapper : 'div', classes: 'spoiler soff'},
        {title : 'Заголовок раскрывающегося блока', block  : 'div', classes: 'head'},
        {title : 'Содержимое раскрывающегося блока', block  : 'div', classes: 'content'},
        {title : 'Код в раскрывающемся блоке', inline : 'p', classes : 'code'},
        {title : 'Строка таблицы 1', selector : 'tr', classes : 'i0'},
        {title : 'Строка таблицы 2', selector : 'tr', classes : 'i1'},
        {title : 'Простой параграф', block : 'p', classes : ''}
