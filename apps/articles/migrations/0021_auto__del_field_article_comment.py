...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('articles_article', 'comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comment', null=True, to=orm['articles.Comment'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'articles.comment': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 23, 11, 38, 53, 156000)'}),
