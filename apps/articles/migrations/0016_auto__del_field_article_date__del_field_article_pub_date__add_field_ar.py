...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('articles_article', 'date')

        # Deleting field 'Article.pub_date'
        db.delete_column('articles_article', 'pub_date')

        # Adding field 'Article.pubdate'
        db.add_column('articles_article', 'pubdate', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 18, 9, 40, 2, 859000)), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Article.date'
        db.add_column('articles_article', 'date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 18, 9, 37, 20, 578000)), keep_default=False)

        # Adding field 'Article.pub_date'
        db.add_column('articles_article', 'pub_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Article.pubdate'
        db.delete_column('articles_article', 'pubdate')
    ...
    models = {
        'articles.article': {
            ...
            'pubdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 18, 9, 40, 2, 859000)'}),
        ...
        'articles.comment': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 18, 9, 40, 2, 859000)'}),
