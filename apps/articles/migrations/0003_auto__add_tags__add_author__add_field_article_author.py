...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('articles_article', 'author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.Author'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'articles.comment': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 15, 0, 5, 4, 968000)'}),
