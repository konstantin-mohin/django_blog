...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('articles_comm', (
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 18, 9, 12, 5, 656000))),
        ...
        db.send_create_signal('articles', ['Comm'])
    ...
    models = {
        'articles.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 18, 9, 37, 20, 578000)'}),
        ...
        'articles.comment': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 18, 9, 37, 20, 593000)'}),
