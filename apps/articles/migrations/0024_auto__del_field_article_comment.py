...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('articles_article', 'comment_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('articles_article', 'comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='com', null=True, to=orm['articles.Comment'], blank=True), keep_default=False)
    ...
    models = {
        'articles.article': {
            ...
            'comment': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'comments'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['articles.Comment']"}),
        ...
        'articles.comment': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 23, 17, 0, 12, 375000)'}),
