...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('articles_comment', 'name')

        # Adding field 'Comment.title'
        db.add_column('articles_comment', 'title', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Comment.name'
        db.add_column('articles_comment', 'name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Deleting field 'Comment.title'
        db.delete_column('articles_comment', 'title')
    ...
    models = {
        ...
        'articles.comm': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 18, 1, 59, 13, 15000)'}),
