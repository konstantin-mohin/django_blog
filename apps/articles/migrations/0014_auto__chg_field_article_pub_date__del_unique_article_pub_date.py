...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Article', fields ['pub_date']
        db.delete_unique('articles_article', ['pub_date'])

        # Changing field 'Article.pub_date'
        db.alter_column('articles_article', 'pub_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Article.pub_date'
        db.alter_column('articles_article', 'pub_date', self.gf('django.db.models.fields.DateField')(default=2, unique=True))

        # Adding unique constraint on 'Article', fields ['pub_date']
        db.create_unique('articles_article', ['pub_date'])
    ...
    models = {
        ...
        'articles.comm': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 18, 9, 12, 5, 656000)'}),
