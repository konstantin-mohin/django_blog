...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('articles_article', (
            ...
            ('slug_title', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, db_index=True)),
            ('preview', self.gf('django.db.models.fields.CharField')(max_length=2550)),
        ...
        db.create_table('articles_category', (
            ...
            ('slug_title', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, db_index=True)),
            ('preview', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
        ...
        db.create_table('articles_comment', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='com_prod_user', null=True, to=orm['auth.User'])),
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 14, 20, 15, 54, 531000))),
    ...
    models = {
        ...
        'articles.comment': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 14, 20, 15, 54, 531000)'}),
