...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('articles_tags', (
            ...
            ('slug_title', self.gf('django.db.models.fields.SlugField')(max_length=128, unique=True, db_index=True)),
    ...
    models = {
        ...
        'articles.comment': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 16, 17, 54, 46, 656000)'}),
