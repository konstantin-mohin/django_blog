...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('articles_article', 'comment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comment', null=True, to=orm['articles.Comment']), keep_default=False)
    ...
    models = {
        'articles.article': {
            ...
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'comment'", 'null': 'True', 'to': "orm['articles.Comment']"}),
        ...
        'articles.comment': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 23, 10, 53, 15, 15000)'}),
